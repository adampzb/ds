...
from apps.groups.models import Group, GroupMember, GroupInvite, GroupRule, MemberRequest


class GroupForm(forms.ModelForm):
    description = forms.CharField(widget=forms.Textarea(attrs={'rows': 6, 'cols': 80}))
